...
function MostrarLibro() {
    ...
    let [libro, setLibro] = useState({}); //<--- lista de items del pedido actual [{isbn13, cantidad, precio}, {isbn13, cantidad, precio}, ...
                ...
                <div className="mb-3" style={{ maxWidth: "540px" }}>
                    <div className="row g-0">
                        <div className="col-md-4" style={{ height: "170px" }}>
                            ...
                            <button className="btn btn-primary btn-sm" id="btnComprar-libro.ISBN13" onClick={() => {
                ...
                <div className="bg-light p-3 border border-1">
                    <div className="container bg-white border border-1 p-2">
                        ...
                        <div className="d-flex justify-content-center py-3 px-1">
                            <button className="btn btn-primary w-100 p-2" id={"btnComprar-" + libro.ISBN13} style={{ borderRadius: "0px" }}><i className="fa-solid fa-cart-shopping pe-2"></i><strong> Comprar / Recoger</strong></button>
                        </div>
